...
class PaymentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_payments_demands1_idx' => ['type' => 'index', 'columns' => ['demands_id', 'demands_services_id', 'demands_people_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_payments_demands1' => ['type' => 'foreign', 'columns' => ['demands_id', 'demands_services_id', 'demands_people_id'], 'references' => ['demands', '1' => ['id', 'services_id', 'people_id']], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
