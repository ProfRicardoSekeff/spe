...
class PeopleController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['PeopleType', 'Departments']
        ];
    ...
    public function view($id = null)
    {
        $person = $this->People->get($id, [
            'contain' => ['PeopleType', 'Departments', 'Services']
        ]);
    ...
    public function add()
    {
        ...
        $peopleType = $this->People->PeopleType->find('list', ['limit' => 200]);
        $departments = $this->People->Departments->find('list', ['limit' => 200]);
        $services = $this->People->Services->find('list', ['limit' => 200]);
        $this->set(compact('person', 'peopleType', 'departments', 'services'));
    }
